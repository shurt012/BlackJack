...
public class BlackJack2
{
    ...
    private List<Player> playersPlaying = new CopyOnWriteArrayList<Player>(); // THREAD SAFETY ARRAY
    private Player dealer;
    private boolean dealerIsNotDealtHisSecondCard = true;
    private int[] totalDeck; // WE WILL STORE ALL THE DECKS NEEDED IN HERE
    private final int numOfDecks = 6; // THIS NUMBER IS HARDCODED IT WOULD BE BETTER IF ITS NOT
    ...
    class Player extends Thread
    {
        ...
        public void getCards(int playerNumber, int totalNumberOfPlayers)
        {
            ...
            if (TYPE_OF_PLAYER.equalsIgnoreCase("Dealer"))
            {
                ...
                userHand.addElement(getArrayCard(playerNumber + 1));
    ...
    /**
     * THINGS YOU NEED playBlackJack() - This method should - Calculate the
     * number of decks need as the number of players change the conversion would
     * be for every 10 player we would need 1 decks
     */
    public boolean playBlackJack()
    {
         ...
         * System.out.println("This is the deck of cards."); for (int cardOn =
         * 0; cardOn < cardCt; cardOn++) {
